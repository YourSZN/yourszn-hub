...
function showClientsTab(tab) {
  ...
  var btnIvorey = document.getElementById('cst-ivorey');
  ...
  var panelIvorey = document.getElementById('clients-ivorey-panel');
  ...
  if (tab === 'inperson') {
    ...
    if (btnIvorey) btnIvorey.classList.add('on');
    if (panelIvorey) panelIvorey.style.display = 'block';
    if (psub) psub.textContent = 'Ivorey online submissions from Google Sheets';
