...
(function () {
  ...
  function fixUnhideTask() {
    ...
    window.unhideTask = function(taskId) {
      ...
      // v38: also remove from master store
  ...
  // v38: sync window.hiddenTasks to only show entries for current week
  // All entries always preserved in window.__allHiddenTasks (master store)
